...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<MovieDetailBloc>().add(GetDetailMovie(widget.id));
    });
    Future.microtask(() => context
        .read<MovieRecommendationsBloc>()
        .add(MovieRecommendations(widget.id)));
    Future.microtask(() => context
        .read<AddMovieWatchlistBloc>()
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              child: Row(
                                ...
                                children: [
                                  BlocBuilder<AddMovieWatchlistBloc,
                                          MovieDetailState>(
                                      builder: ((context, state) {

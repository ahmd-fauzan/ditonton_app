...
import 'package:core/data/models/movie_series_model/movie_detail_model.dart';
import 'package:core/data/models/movie_series_model/movie_model.dart';
...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      ...
      when(mockLocalDataSource
              .insertWatchlist(MovieTable.fromEntity(testMovieDetail)))
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockLocalDataSource
              .removeWatchlist(MovieTable.fromEntity(testMovieDetail)))
